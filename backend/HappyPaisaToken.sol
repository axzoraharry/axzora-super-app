 ...
 * @dev A collateral-backed stable token where 1 HP = 11 USDT
 * The contract maintains a collateral pool of USDT to back the HP tokens
 */
contract HappyPaisaToken is ERC20, Ownable, ReentrancyGuard, Pausable {
    IERC20 public immutable USDT;
    
    // 1 HP = 11 USDT (using 6 decimals for USDT precision)
